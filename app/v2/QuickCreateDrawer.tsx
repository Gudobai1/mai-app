...
export function QuickCreateDrawer({ kind, state, today, commit, onClose }: Props) {
  const [draft, setDraft] = useState<Row>(kind === 'task'
    ? { titulo: '', descricao: '', data: today, hora: '', prioridade: 4, projeto_id: 'entrada' }
    : { titulo: '', descricao: '', data: today, hora_inicio: '', hora_fim: '', dia_inteiro: false })
