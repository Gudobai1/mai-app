...
const paths: Record<string, string> = {
  ...
  inbox:'M4 5h16v14H4zM4 14h5l2 3h2l2-3h5', today:'M6 3v3m12-3v3M4 8h16v12H4zM8 12h4v4H8z', upcoming:'M6 3v3m12-3v3M4 8h16v12H4zM8 12h8m-8 4h5', calendar:'M6 3v3m12-3v3M4 8h16v12H4z', completed:'M12 22a10 10 0 1 0 0-20 10 10 0 0 0 0 20ZM7.5 12l3 3 6-6',
  ...
  folder:'M3 6h7l2 2h9v11H3z', edit:'M4 20h4L19 9l-4-4L4 16v4ZM13.5 6.5l4 4', view_column:'M4 5h16v14H4zM10 5v14m4-14v14', account_tree:'M6 4v5h6m0 0v6m0-6h6v5M9 20h6v-5H9v5ZM3 9h6V4H3v5Zm12 10h6v-5h-6v5Z', content_copy:'M8 8h11v11H8zM5 16H4V5h11v1', archive:'M4 7h16v13H4zM3 4h18v4H3zM9 11h6', delete:'M5 7h14M9 7V4h6v3m-8 0 1 13h8l1-13M10 11v5m4-5v5',
